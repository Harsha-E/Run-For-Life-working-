...
function preload() {
  ...
  img_body = loadImage("all/images/body.png");

  img_leg = loadImage("all/images/leg2.png");

  img_lower_arm = loadImage("all/images/lower_arm2.png");

  img_upper_arm = loadImage("all/images/upper_arm.png");

  img_full_background = loadImage("all/images/2Full_Background2.png");

  img_water = loadImage("all/images/Water.png");

  img_orange_buoy = loadImage("all/images/Orange_buoy.png");

  img_black_buoy = loadImage("all/images/Black_buoy.png");

  img_red_buoy = loadImage("all/images/Red_buoy.png");

  car1_img = loadAnimation("all/images/tile000.png", "all/images/tile001.png", "all/images/tile002.png", "all/images/tile003.png");

  car2_img = loadAnimation("all/images/tile000.png", "all/images/tile001.png", "all/images/tile002.png", "all/images/tile003.png");

  car3_img = loadAnimation("all/images/tile000.png", "all/images/tile001.png", "all/images/tile002.png", "all/images/tile003.png");

  car4_img = loadAnimation("all/images/tile000.png", "all/images/tile001.png", "all/images/tile002.png", "all/images/tile003.png");
